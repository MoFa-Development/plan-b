...
window.Settings = {
    ...
    save: function() {
        ...
        for(var category of Object.keys(Settings.categories)) {
            ...
            if(Settings.categories[category] === undefined)
                continue
            
            if (!Settings.categories[category].settings)
                Settings.categories[category].settings = {}

            var settings = Settings.categories[category].settings
...
// TODO: Implement hidden class filter setting
